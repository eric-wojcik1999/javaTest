...
public class Null 
{
	...
	//Importing fonts and specifying W/H
	public Null(String file, int w, int h)
	{
		this.w = w;
		this.h = h; 
	...
	private BufferedImage loadFont(String file)
	{
		...
		{
			System.out.println("ERROR: could not read the file and meme");
		}
		return font; 
	}
	...
	{
		int value = letter - 65; //To accomodate for ascii values 
